...
impl RootView {
    pub fn new(
        ...
        // OpenCode backend is always active; condition is always true.
        let auth_onboarding_state = if auth_state.is_logged_in() || true {
    ...
    fn handle_agent_onboarding_event(
        ...
        match event {
            ...
            AgentOnboardingEvent::OnboardingCompleted(selected_settings) => {
                ...
                // OpenCode backend is always active; login is never required here.
